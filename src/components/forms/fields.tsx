...
const labelClassName =
  "block dark:bg-neutral-100/10 bg-white ps-3 pe-2.5 py-0.5 font-sans rounded-tl-[11px] tracking-wider text-[10px] top-0 left-0 rounded-e rounded-bl m-[3px] font-medium text-raised/80 dark:text-white/60 uppercase";
