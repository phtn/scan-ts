  ...
  return (
    <Card
      className={cn(
        ...
        "dark:border-panel lg:rounded-xl lg:rounded-br-[3px] rounded-none rounded-s-xl border-[0.33px] border-gray-500 border-e-0 lg:border-e-[0.33px]",
        "dark:from-neutral-800/40 dark:via-neutral-500/80 dark:to-neutral-800/80",
